...
<div class="container">
  ...
  <br><br>
  <button type="button" class="btn btn-primary btn-lg btn-block"><a style="color:white" href="getformadduser.ldz">Ajouter un utilisateur</a></button>
  <br><br>
  <div id='calendar'></div>
  ...
  <div class="form-group row">
      <div class="col-xs-6 col-sm-8 col-md-9 col-lg-10"style=" margin-left: 52px;">
        <table class="table table-hover">
          <tr>
            <th>Nom</th><th>Prénom</th><th>E-mail</th><th>Téléphone</th><th>Modifier</th><th>Supprimer</th>
          </tr>
