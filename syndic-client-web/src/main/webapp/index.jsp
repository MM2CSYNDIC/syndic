    ...
    <div class="container">
        ...
        <nav id="bou" class="navbar navbar-inverse navbar-static-top">
            <a class="navbar-brand" href="#">
                <img src="/WEB-INF/views/pages/images/logo.png" alt="">
            </a>
            <div class="container">
        ...
        <div class="item active">
            ...
            <div class="container">
                <div class="carousel-caption">
                    <h1>Gestion des événement de la copropriété</h1>
                    <p>
                        Cette application vous permet de gérer les événements de votre copropriété : organisation des assemblées générales, ..
                    </p>
